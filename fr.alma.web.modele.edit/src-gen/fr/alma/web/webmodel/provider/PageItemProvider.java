...
import fr.alma.web.webmodel.Page;
...
/**
 * This is the item provider adapter for a {@link fr.alma.web.webmodel.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ModelePackage.Literals.PAGE__TITLE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelePackage.Literals.PAGE__ARTICLES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ModelePackage.PAGE__TITLE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ModelePackage.PAGE__ARTICLES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(ModelePackage.Literals.PAGE__ARTICLES, ModeleFactory.eINSTANCE.createArticle()));
	}
